...
/usr/sbin/groupadd -g 497 vagrant || true
/usr/sbin/useradd  -g 497 -u 497 -s /bin/bash -c "Vagrant" -m -d /home/vagrant vagrant || true
echo vagrant | passwd --stdin vagrant

/usr/sbin/groupadd -g 498 vboxsf || true
/usr/sbin/useradd  -g   1 -u 498 -s /bin/false -r -d /var/run/vboxadd          vboxadd || true
